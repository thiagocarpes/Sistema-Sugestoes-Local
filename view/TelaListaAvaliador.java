...
public class TelaListaAvaliador {
   ...
   public TelaListaAvaliador(){
      ...
      TelaMain.setContent("Avaliadores - São Judas", "Avaliadores", coluns, c);
      ...
      StyleLabels txt1 = new StyleLabels("Lista de Avaliadores.", "#444444", 18, coluns, f);
      ...
      try {
         ...
         while(rst.next()){
           ...
           //line.setOpaque(false);
            ...
            StyleLabels titulo = new StyleLabels(rst.getString("nome"), "#444444", 15, line, c);
            titulo.setCursor(new Cursor(Cursor.HAND_CURSOR));
                     
            c.anchor = GridBagConstraints.LAST_LINE_END;
            c.insets = new Insets(0, 0, 0, 0);
            StyleButtons btnVerSugestao = new StyleButtons("Editar Avaliador", 12, "Green", line, "Vazio", c);           
            int idUsuario = rst.getInt("idUsuario");
            btnVerSugestao.addActionListener(
               new ActionListener(){
                  public void actionPerformed(ActionEvent e){
                     EditarAvaliador EA = new EditarAvaliador(idUsuario);
      ...
      f.insets = new Insets(0, 0, 0, 0);
      StyleButtons salvar = new StyleButtons("NOVA AVALIADOR" , 14, "Green", coluns, "Cheio", f);
   ...
   public ResultSet getSugestoes(Connection conn){
      ...
      String query = "SELECT * FROM usuarios where tipo = 2";   
